...
Page({
  ...
  data: {
    ...
    //9张奖品图片
    images: ['/images/item.png', '/images/item1.png', '/images/item2.png', '/images/item1.png', '/images/item.png', '/images/item1.png', '/images/item2.png', '/images/item.png', '/images/item.png'],
